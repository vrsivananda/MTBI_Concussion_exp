...
jsPsych.plugins["dynamic-visual-feedback"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var end_trial = function() {
      ...
      let stimulusString = JSON.stringify(trial.sources);
      let frameTimeString = JSON.stringify(frameTime);
      let frameTimeFromStartString = JSON.stringify(frameTimeFromStart);
      let magnitudesString = JSON.stringify(magnitudes);
      let degreesString = JSON.stringify(degrees);
      
      console.log("stimulusString:");
      console.log(stimulusString);

      // gather the data to store for the trial
      var trial_data = {
        stimulus: stimulusString,
        frameTime: frameTimeString,
        frameTimeFromStart: frameTimeFromStartString,
        magnitudes: magnitudesString,
